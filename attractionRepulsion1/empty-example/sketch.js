...
const G = 7e-3, //G  = gravitational constant
      G2 = 2e-0, //G2 = repelling constan
      atomRConst = 4 ; //atomRConst = scale of atoms
const atomProtonExp = 2 //exponent which influences repulsion
const constDampening = 1e-3 //the fraction  by which velocity is dampened every frame
let atoms = []
let debugLog = '' //for manipulating and logging to console at appropriate times
let minAtoms = 100 //start spawning atoms randomly if there are fewer than this nr of atoms
